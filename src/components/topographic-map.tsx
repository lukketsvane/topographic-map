...
function Terrain({ 
  ...
  useFrame((state) => {
    ...
    if (mesh.current && mesh.current.material) {
      ...
      material.uniforms.uElevation.value = maxElevation
      material.uniforms.uWarping.value = warping
      material.uniforms.uRidgeFrequency.value = ridgeFrequency
      material.uniforms.uRidgeHeight.value = ridgeHeight
      material.uniforms.uTerraceStep.value = terraceStep
      material.uniforms.uTerraceSmoothing.value = terraceSmoothing
      material.uniforms.uLowColor.value = new THREE.Color(lowColor)
      material.uniforms.uHighColor.value = new THREE.Color(highColor)
      material.uniforms.uColorStrength.value = colorStrength
      material.uniforms.uColorDiffusion.value = colorDiffusion
      material.uniforms.uLineColorMode.value = lineColorMode
...
const EditableValue: React.FC<EditableValueProps> = ({ value, onChange, min, max, step, label }) => {
